...
- (void)configShareView{
    ...
    [friendBtn setImage:[UIImage imageNamed:@"qzone_normal"] forState:UIControlStateNormal];
...
- (WBMessageObject *)messageToShare
{
    ...
    image.imageData = [NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"purly" ofType:@"png"]];
